...
<i>application-{datasource}.yaml</i>
<p>
   <li> url: Задается путь до баззы данных и название схемы</li>
   <li> username: Задается имя пользователя MySql</li>
   <li> password: Задается пароль MySql</li>
</p>
<p>
...
https://github.com/IaPiton/Diplom
...
должны находиться файлы <i>application.yaml</i>. 
